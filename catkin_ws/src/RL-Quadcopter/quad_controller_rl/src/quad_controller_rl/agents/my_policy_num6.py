...
# For Hovering task
# Improved! This replaces MyPolicyNum4
...
from quad_controller_rl.agents.ddpg_actor_hover import Actor
from quad_controller_rl.agents.ddpg_critic_hover import Critic
...
class DDPG(BaseAgent):
    ...
    def __init__(self, task):
        ...
        #self.model_name = "ddpg_hover"
        self.model_name= os.path.join(util.get_param('out'),"ddpg_hover_weights_{}".format(util.get_timestamp()))
        self.model_ext = ".h5"
        ...
        # Save episode stats
        self.stats_filename = os.path.join(util.get_param('out'),"ddpg_hover_stats_{}.csv".format(util.get_timestamp()))  # path to CSV file
